...
/** Merges the previously-separate Business (Revenue & Billing, Compliance)
 *  and EBM/EBM Config sidebar entries into one "Finance & EBM" item with an
 *  internal sub-nav — every /ebm/* page keeps its own PageHead, so the shell
 *  renders no title of its own here. */
