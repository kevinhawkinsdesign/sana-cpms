...
import DashboardOrganizationDetailClient from './DashboardOrganizationDetailClient';
...
export function generateStaticParams() {
  return db.organizations.map((o) => ({ organizationId: o.id }));
}

export default function Page() {
  return <DashboardOrganizationDetailClient />;
}
